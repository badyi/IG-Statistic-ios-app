...
final class AuthPresenter: AuthPresenterProtocol {
    ...
    func instUserIDLoaded() {
        let defaults = UserDefaults(suiteName: AppGroupManager.bundle())
        defaults?.setValue(credentials?.instUserID, forKey: "instID")
        defaults?.setValue(credentials?.fbAccessToken, forKey: "FBtoken")
    ...
    func clearDefaults() {
        ...
        let defaults = UserDefaults(suiteName: AppGroupManager.bundle())
        defaults?.removeSuite(named: "group.badyi.IG-Statistic")
    }
}
